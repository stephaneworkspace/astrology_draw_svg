...
pub fn draw_bodie(bodie: Bodies) -> Document {
    ...
    if bodie == Bodies::Sun {
        ...
        let data3 = Data::new()
            ...
            .cubic_curve_to((
                361.949, 491.11663, 365.58176, 487.72643, 369.21452, 487.72643,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                376.48003, 502.1348, 371.93909, 511.45787, 362.85719, 511.45787,
            )); //C
        let path1 = Path::new()
            .set("fill", "none")
            .set("stroke", "black")
        ...
        let data1 = Data::new()
            ...
            .cubic_curve_to((
                361.22262, 505.2704, 365.64653, 507.97556, 374.49435, 507.97556,
            )) // C
            .cubic_curve_to((
                383.34217, 507.97556, 387.76609, 505.2704, 385.11174, 487.23598,
            )); // C
        let data2 = Data::new()
        ...
        let data = Data::new()
            ...
            .cubic_curve_to((
                8.3866265, 25.47396, 10.353226, 28.690578, 12.668968, 31.574724,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                4.3067545, 40.577398, 7.1279375, 35.698781, 11.06621, 35.699006,
            )) //  C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                9.3676865, 33.307515, 5.8037275, 33.58719, 3.3704395, 35.210424,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                9.7104595, 50.27834, 13.341653, 50.11482, 15.914542, 48.217129,
            )) // C
            .cubic_curve_to((
                19.719853, 46.146325, 21.076807, 41.160698, 20.493903, 36.98712,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                13.874366, 22.916047, 11.614725, 15.94564, 14.417225, 10.804622,
            )) //  C
            .cubic_curve_to((
                16.06608, 7.3630031, 20.222278, 4.3452381, 24.61182, 4.2941071,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                39.010912, 50.93287, 45.806814, 49.664633, 48.167235, 44.739305,
            )) // C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                37.966082, 29.775828, 40.327674, 27.64413, 41.390812, 24.709601,
            )) //  C
            .cubic_curve_to((
            ...
            .cubic_curve_to((
                23.52701, 0.9920241, 22.347291, 1.0659511, 21.176252, 1.2059591,
            )) // C
            .close(); // z
        let path = Path::new()
            .set("fill", "black")
